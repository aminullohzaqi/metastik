...
<body>
    ...
    <div class="main">
        <h3>Search Data</h3>
        <br>
        <form action="querytable.php" method="get">
            <div class="col-md-5">
                <label for="stasiun">Stasiun</label>
                <select name="getStasiun" id="stasiun" class="form-control">
            ...
            <div class="col-md-3 d-flex">
                ...
                <div style="padding-left: 30px;">
                    ...
                    <input type="submit" name="tsearch" value="Cari" class="btn btn-info" style="margin-top: 10px;">
                </div>
            </div>
        </form>
    </div>    
